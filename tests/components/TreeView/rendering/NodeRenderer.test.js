...
describe('NodeRenderer', () => {
  ...
  describe('NODE_RENDERER_CONSTANTS', () => {
    test('should export expected constants', () => {
      expect(NODE_RENDERER_CONSTANTS.NODE_WIDTH_WITH_PHOTO).toBe(85);
      expect(NODE_RENDERER_CONSTANTS.NODE_HEIGHT_WITH_PHOTO).toBe(105);
      ...
      expect(NODE_RENDERER_CONSTANTS.CORNER_RADIUS).toBe(13);
