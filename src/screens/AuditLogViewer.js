        ...
        <GlassSurface style={styles.logItem}>
          <View style={styles.logHeader}>
            <View style={[styles.actionIcon, { backgroundColor: `${actionInfo.color}20` }]}>
              <Ionicons name={actionInfo.name} size={20} color={actionInfo.color} />
            </View>
            <View style={styles.logInfo}>
              <View style={styles.logTitleRow}>
                <Text style={styles.logAction}>{getActionLabel(log.action)}</Text>
                <Text style={styles.logTable}>{getTableLabel(log.table_name)}</Text>
              </View>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValue}>{getTableLabel(selectedLog.table_name)}</Text>
              </View>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValue}>{selectedLog.actor_id || 'غير محدد'}</Text>
              </View>
                ...
                {['create', 'update', 'delete', 'revert'].map(action => (
                  ...
                  >
                    <Text style={[
                      ...
                      filters.action === action && styles.filterOptionTextActive
                    ]}>
              ...
              <View style={styles.filterOptions}>
                {['profiles', 'marriages'].map(table => (
                  ...
                  >
                    <Text style={[
                      styles.filterOptionText,
                      filters.table_name === table && styles.filterOptionTextActive
                    ]}>
                      {getTableLabel(table)}
                    </Text>
                  </TouchableOpacity>
        ...
        <View style={styles.activeFilters}>
          {filters.action && (
            <View style={styles.activeFilter}>
              <Text style={styles.activeFilterText}>{getActionLabel(filters.action)}</Text>
            </View>
          )}
          {filters.table_name && (
            <View style={styles.activeFilter}>
              <Text style={styles.activeFilterText}>{getTableLabel(filters.table_name)}</Text>
            </View>
          )}
        </View>
      )}
