-- Fix search_name_chain to support partial matching AND return all required fields
-- Root Cause: New function was missing professional_title and title_abbreviation fields
-- Frontend expects: formatNameWithTitle() needs professional_title and title_abbreviation
-- Impact: Search completely broken - frontend couldn't format names properly
