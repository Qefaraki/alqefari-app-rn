-- Enhanced Statistics Function with Munasib (Married-in Family) Analytics
-- This replaces the old admin_get_statistics function with enhanced metrics
            ...
            'top_families', COALESCE(
                (SELECT json_agg(
                    json_build_object(
                        ...
                        'count', count,
                        'percentage', ROUND((count::numeric / munasib_stats.total_munasib) * 100, 1)
                    )
