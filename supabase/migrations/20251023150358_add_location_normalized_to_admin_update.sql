-- Migration: Add location normalized fields to admin_update_profile() whitelist
-- Purpose: Enable saving normalized location data from LocationInput component
-- Impact: Users can now save birth_place_normalized and current_residence_normalized
...
BEGIN
    ...
    -- Update profile with whitelisted fields (now including birth_place_normalized and current_residence_normalized)
    UPDATE profiles SET
