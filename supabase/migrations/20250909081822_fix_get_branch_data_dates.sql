-- URGENT FIX: Run this SQL in your Supabase Dashboard SQL Editor
-- Go to: https://supabase.com/dashboard/project/ezkioroyhzpavmbfavyn/sql/new
-- This fixes the date display issue by updating get_branch_data to include date fields

-- Step 1: Drop the existing function
DROP FUNCTION IF EXISTS get_branch_data(TEXT, INT, INT);

-- Step 2: Recreate with all fields including dates
...
BEGIN
    ...
    SELECT 
        ...
        -- Include ALL fields from profiles table
        dt.dob_data,
        dt.dod_data,
        dt.bio,
        dt.birth_place,
