-- Migration: Fix Batch Save Audit Log Column Name (Bug #11)
-- Issue: INSERT INTO audit_log_enhanced references non-existent "profile_id" column
-- Error: "column \"profile_id\" of relation \"audit_log_enhanced\" does not exist"
-- Root Cause: Table uses "record_id" not "profile_id"
-- Fix: Change all 3 INSERT statements (CREATE, UPDATE, DELETE loops)
-- Status: BUG #11 - Discovered during fifth test attempt
...
BEGIN
  ...
  LOOP
    ...
    -- BUG #11 FIX: Use record_id not profile_id
  ...
  LOOP
    ...
    -- UPDATE with complete 20-field support (Bug #9 fix) and proper array casting (Bug #10 fix)
    UPDATE profiles
    SET
      -- Basic Info (5 fields)
...
'Atomic batch operation for QuickAdd overlay. Fixed Bug #11: audit_log_enhanced uses record_id not profile_id. All 11 bugs resolved. Complete 20-field support.';
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '=================================================================';
  RAISE NOTICE 'MIGRATION 20251015260000: Fix Audit Log Column (Bug #11)';
  RAISE NOTICE '=================================================================';
  RAISE NOTICE '';
  RAISE NOTICE '✅ Fixed Bug #11: audit_log_enhanced column name';
  RAISE NOTICE '';
  RAISE NOTICE '❌ BROKEN: INSERT INTO audit_log_enhanced (... profile_id ...)';
  RAISE NOTICE '✅ FIXED: INSERT INTO audit_log_enhanced (... record_id ...)';
  RAISE NOTICE '';
  RAISE NOTICE '📋 Changes in 3 locations:';
  RAISE NOTICE '   ✅ CREATE loop - audit log INSERT';
  RAISE NOTICE '   ✅ UPDATE loop - audit log INSERT';
  RAISE NOTICE '   ✅ DELETE loop - audit log INSERT';
  RAISE NOTICE '   ✅ Added table_name field for consistency';
  RAISE NOTICE '';
  RAISE NOTICE '🎯 All 11 bugs now fixed:';
  ...
  RAISE NOTICE '   ✅ Bug #11: Audit log column name (this migration)';
  RAISE NOTICE '';
  RAISE NOTICE '🚀 Function should NOW work (correct audit table schema!)';
  RAISE NOTICE '🎯 Ready for sixth test attempt';
  RAISE NOTICE '';
  RAISE NOTICE '=================================================================';
END $$;
