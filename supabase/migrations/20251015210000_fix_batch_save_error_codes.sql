-- Migration: Fix Batch Save Error Codes to Use Standard SQLSTATE
-- Issue: Custom error code names cause "unrecognized exception condition" error
-- Solution: Use P0001 (raise_exception) which is PostgreSQL's standard for user errors
-- Impact: Matches pattern used in other working RPC functions

-- ============================================================================
-- FUNCTION REPLACEMENT WITH STANDARD ERROR CODES
-- ============================================================================
...
'Atomic batch operation for QuickAdd overlay. Uses standard P0001 error codes. Supports create/update/delete with full safety mechanisms.';
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '=====================================================';
  RAISE NOTICE 'MIGRATION 20251015210000: Fix Error Codes';
  RAISE NOTICE '=====================================================';
  RAISE NOTICE '';
  RAISE NOTICE '✅ Replaced all custom error codes with P0001';
  RAISE NOTICE '✅ Check violations use 23514 (check_violation)';
  RAISE NOTICE '✅ Lock conflicts use lock_not_available';
  RAISE NOTICE '';
  RAISE NOTICE '🎯 Function is now production-ready';
  RAISE NOTICE '';
  RAISE NOTICE '=====================================================';
END $$;
