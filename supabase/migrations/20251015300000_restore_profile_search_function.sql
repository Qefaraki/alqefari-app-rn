-- Restore search_profiles_by_name_chain function for onboarding
-- This function provides accurate match scoring and full name chains
-- which the fallback query cannot provide
...
BEGIN
  ...
  matches AS (
    SELECT
      ...
      array_to_string(ma.name_chain, ' ', 'القفاري') as full_chain,
      p.generation,
