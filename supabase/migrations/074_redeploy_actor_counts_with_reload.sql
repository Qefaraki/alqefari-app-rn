-- Migration 074: Redeploy get_actor_activity_counts with schema reload
-- Fix: PostgREST schema cache not picking up the function

-- Drop and recreate to ensure clean state
DROP FUNCTION IF EXISTS get_actor_activity_counts();
...
DO $$
BEGIN
  RAISE NOTICE 'Migration 074: get_actor_activity_counts redeployed and schema reloaded';
END $$;
